...
This App uses the `survival` package. For more information read the respective documentation in [cran](https://cran.r-project.org/web/packages/survival/index.html), and wikipedia's entry for [survival analysis](https://en.wikipedia.org/wiki/Survival_analysis).
...
Please keep the version tag on all downloaded files.
